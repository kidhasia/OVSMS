...
<footer class="footer">
    ...
    <div class="footer-container">
        ...
        <div class="footer-logo">
            <img src="path_to_your_logo.png" alt="SpareMart Logo"> <!-- Replace with the actual path to your logo -->
        </div>
    </div>
    <div class="footer-bottom">
        <p>Copyright 2022 © SpareMarts.com All Rights Reserved.</p>
        <div class="footer-social">
            <a href="#"><img src="path_to_facebook_icon.png" alt="Facebook"></a> <!-- Replace with actual social media icons -->
